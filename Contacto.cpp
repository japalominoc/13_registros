    ...
    do{
        ...
        switch(op){
            ...
            case 2:
                ...
                break;
            case 3:
                cout<<"Ingrese el contacto que desea modificar:";
                cin>>modi;
                cout<<"¿Desea modificar el nombre del contacto?(S/N): ";
                cin>>op2;
                    if(op2='S'){
                        cout<<"Ingrese el nombre del contacto: "; getline(cin,nom);
                }
                cout<<"¿Desea modificar el sexo?(S/N): ";
                cin>>op2;
                    if(op2='S'){
                        cout<<"Ingrese el sexo (M/F): "; cin>>sex;
                    }
                ...
                cout<<"¿Desea modificar el correo?(S/N): ";
                cin>>op2;
                    if(op2='S'){
                        cout<<"Ingrese el correo electronico (usuario@dominio): "<<endl;
                    }
